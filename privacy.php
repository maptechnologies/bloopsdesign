        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 privacy">
                ...
                <div class="newsle">
					...
					<p>At Websites Designs Agency, the privacy of our clients is our top priority on <a href="www.websitesdesignsagency.ca ">www.websitesdesignsagency.ca </a> and we respect it as our own. Though we collect information from our clients, it is only used to make improvements in our customer services. Our company acknowledges that the maintenance and use of our clients' information is our responsibility. We DO NOT rent or sell the information that our clients provide us online.</p>
				...
				<div class="newsle">
					...
					<p>As a client, one might also receive updates regarding our site and services which may include a newsletter and information on promotions. In addition, we may also use the information about your interests and purchases to help our company improve our site design and the client's purchasing experience.
				...
				<div class="newsle">
					...
					<p>If you no longer wish to receive our newsletter and promotional communications, you may opt-out of receiving them by following the instructions included in each newsletter or communication or by emailing us at Or calling us at +1 (647) 699-1240
                    </p>
				</div>
				<div class="newsle">
			...
			<div class="newsle">
                    ...
                    <p>If you have any questions about security on our Web site, you can send email us at info@websitesdesignsagency.ca</p>
			</div>
			<div class="newsle">
				...
				<div class="newsle">
					<h3>Testimonials</h3>
					<p>With your consent we may post your testimonial along with your name. If you want your testimonial removed please contact us.
                    </p>
				</div>
				<div class="newsle">
					<h3>Links to Other Web Sites</h3>
					<p>Our Site includes links to other Web sites whose privacy practices may differ from those of ours. If you submit personal information to any of those sites, your information is governed by their privacy statements. We encourage you to carefully read the privacy statement of any Web site you visit.
                    </p>
				</div>
				<div class="newsle">
				...
				<div class="newsle">
					<h3>Questions</h3>
                    <p>If you have any questions regarding our Privacy Policy or our use of your information, call our toll free number +1 (647) 699-1240 or email us on info@websitesdesignsagency.ca</p>
				</div> 
